                      ...
                      return Dismissible(
                        ...
                        child: Padding(
                          ...
                          child: Material(
                            ...
                            child: new ListTile(
                              title: Text(
                                widget.data.listItems[index],
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    fontSize:
                                        Size_Config.blockSizeHorizontal * 5,
                                    fontWeight: FontWeight.bold),
                              ),
                              subtitle: Text(
                                widget.data.listSubtitles[index],
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    fontSize:
                                        Size_Config.blockSizeHorizontal * 3,
                                    color: Colors.grey[900]),
                              ),
                              leading: Icon(
                                widget.data.listIcons[index],
                                size: Size_Config.blockSizeVertical * 5,
                                color: Colors.cyan,
                              ),
                            ),
                          ),
